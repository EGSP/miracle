...
export const validationMap: Record<string, {
    ...
    'POST /order/:id/analyse-details': { query: parseAnalyseOrderDetailsQuery, params: parseAnalyseOrderDetailsParams },
    ...
    'GET /workers/:id/preview-prompt': { params: parsePreviewPromptParams },
