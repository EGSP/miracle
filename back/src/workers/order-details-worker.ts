    ...
    requirements: z
        .array(
            z.object({
                point: z
                    .string()
                    .describe('Название параметра или требования (например: "Материал", "Диаметр", "Климатическое исполнение")'),
                description: z
                    .string()
                    .describe('Значение или описание требования (например: "Сталь 45", "32 мм", "Цинкование")'),
            }),
        )
        .describe('Список технических и коммерческих требований к заказу, извлечённых из текста')
        .optional(),
});
