...
Для каждого пункта с отметкой выведи одну строку:
  Требуется: <полный текст пункта из документа>
или
  Не требуется: <полный текст пункта из документа>

Не используй символы отметок (☑, ✓, [x] и т.п.) и не пиши «отмечено» / «выбран вариант N» — только эти две формулировки и дословный текст пункта.
Остальной текст документа извлекай как обычно, в том же порядке.
