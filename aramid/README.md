...
- [Документация компонентов (`docs/`)](#документация-компонентов-docs)
...
<Grid>
  <Column span={8}>Левая колонка</Column>
  <Column span={8}>Правая колонка</Column>
</Grid>
```

Подробные руководства по пропсам, переменным и практикам — в каталоге [`docs/`](./docs/README.md).

---

## Документация компонентов (`docs/`)

- [Оглавление `docs/README.md`](./docs/README.md) — ссылки на **GRID**, **COLUMN**, **STACK**, **ASPECTRATIO**.
