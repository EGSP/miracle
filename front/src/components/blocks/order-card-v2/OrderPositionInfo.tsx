...
export function OrderPositionInfo({ item }: { item: OrderPositionWithDesignation }) {
  ...
  return (
    <div className="position-info">
      {/* Фиксированная шапка: название + условное обозначение */}
      <Stack gap={4}>
        <Stack gap={1}>
      ...
      {/* Скролл-контейнер: всё ниже обозначения (таблица параметров, требования, итоги) */}
      <div className="position-info__scroll">
        <Stack gap={4}>
          {designation && <DesignationInspector designation={designation} />}
