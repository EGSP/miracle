          ...
          <Stack gap={1}>
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <ArrayEditor
                ...
                onRemove={(j) => update(i, { ruleIds: slot.ruleIds.filter((_, idx) => idx !== j) })}
                renderItem={(ruleId, j) => {
                  const selectedRule = rules.value.find((r) => r.id === ruleId) ?? null
                  ...
                  return (
                    <div className="flex flex-col gap-0.5">
                      ...
                      <Input.Dropdown<TechnicalConditionRule>
                        items={rules.value}
                        value={selectedRule}
                        onChange={(next) => updateRuleId(i, j, next?.id ?? "")}
