      ...
      rows: [
        {
          ...
          label: "Дата",
          weight: "1fr",
          render: (order) => <Text.Label as="span">{formatCreatedAt(order.createdAt)}</Text.Label>,
        },
        {
          key: "author",
          label: "Автор",
